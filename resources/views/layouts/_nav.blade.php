<ul class="space-y-0.5">
    ...
    @if(!Auth::user()->isSuperuser())<li><div class="sidebar-divider"></div></li>@endif
    <li>
        <a href="{{ route('user-types.index') }}"
            class="sidebar-link {{ request()->routeIs('user-types.*') ? 'active' : '' }}">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li>
        <a href="{{ route('manual-attendance.index') }}"
            class="sidebar-link {{ request()->routeIs('manual-attendance.*') ? 'active' : '' }}">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li>
        <a href="{{ route('early-checkout.index') }}"
            class="sidebar-link {{ request()->routeIs('early-checkout.*') ? 'active' : '' }}">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
